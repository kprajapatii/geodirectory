...
== ⚡ QUICK SETUP GUIDE - FREE WORDPRESS BUSINESS DIRECTORY PLUGIN ==
...
== ⚡ USAGE OF WORDPRESS BUSINESS DIRECTORY PLUGINS ==
...
= GeoDirectory v2.8.167 - 2026-07-15 =
...
= GeoDirectory v2.8.165 - 2026-06-24 =
...
= GeoDirectory v2.8.163 - 2026-06-08 =
* Added extra sanitization to term query during search - SECURITY

= GeoDirectory v2.8.162 - 2026-06-04 =
* Added extra validation to prevent SSRF vulnerabilities by restricting unauthorized internal requests - SECURITY

= GeoDirectory v2.8.161 - 2026-05-14 =
...
= GeoDirectory v2.8.159 - 2026-04-23 =
...
= GeoDirectory v2.8.154 - 2026-03-10 =
...
* Prevent listing Ads injection in Recently Viewed Listings widget - CHANGED
...
= GeoDirectory v2.8.132 - 2025-09-11 =
...
= GeoDirectory v2.8.130 - 2025-08-28 =
* Merge AUI 0.2.41 & SD 1.2.26 - CHANGED

= GeoDirectory v2.8.129 - 2025-08-21 =
* Some PHP version shows PHP notice when used comma separated post ids in GD > Listings - FIXED

= GeoDirectory v2.8.128 - 2025-08-14 =
...
* Non-float rating value display error for bar rating style - FIXED
...
* Fix accessibility issue for sub items in GD Categories - FIXED
...
* GD > Simple Archive Item allows to show Distance To Post badge - ADDED

= GeoDirectory v2.8.115 - 2025-05-15 =
* GD > Single Taxonomies, setting added to limit taxonomy count output - ADDED
* GD> Category Description can now be used on single page templates using the default category field - ADDED
* Setup Wizard "Not right now" link not working - FIXED

= GeoDirectory v2.8.114 - 2025-05-08 =
* REST API response don't contains Admin Use field - CHANGED

= GeoDirectory v2.8.113 - 2025-05-01 =
...
* Sometimes CPT sort field saves twice - FIXED
...
= GeoDirectory v2.8.107 - 2025-03-27 =
...
* Changes to add custom args to map marker request - CHANGED
* Added further BIG Data improvements when setting active - ADDED

= GeoDirectory v2.8.104 - 2025-03-06 =
